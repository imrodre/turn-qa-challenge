...
public class AuthorizationPageStateRigthsFlow extends Page{

	public AuthorizationPageStateRigthsFlow(WebDriver driver) {
		super(driver);		
	}
	...
	@FindBy(how = How.XPATH, using  = "//div[@class='sc-kjoXOD UNtpk']/div/div[2]/div[3]/div[5]/div/h2[@class='sc-jzJRlG gqcyfL']/following-sibling::div[2]/div/div/input")
	@CacheLookup
	public WebElement iAgreeCheck;
	
	@FindBy(how = How.XPATH, using  = "//div[@class='sc-kjoXOD UNtpk']/div/div[2]/div[3]/div[5]/div/h2[@class='sc-jzJRlG gqcyfL']/following-sibling::div[2]/div/div/label")
	@CacheLookup
